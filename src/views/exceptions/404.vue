<template>
  <el-row :gutter="120">
    ...
    <el-col :span="12">
      <h1>404</h1>
      <p>抱歉，没有找到此页面。</p>
      <el-button @click="$router.go(-1)" icon="fas fa-fw fa-arrow-alt-circle-left">返回上级</el-button>
      <el-button @click="$router.push('/')" icon="fas fa-fw fa-house-damage" type="primary">回到首页</el-button>
    </el-col>
  </el-row>
</template>
